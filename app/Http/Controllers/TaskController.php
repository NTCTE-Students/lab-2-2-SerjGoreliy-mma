...
class TaskController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Сортировка по дате создания или статусу
        if ($request->has('sort_by')) {
            $sortOrder = $request->input('sort_order', 'asc'); // по умолчанию по возрастанию
            $tasks->orderBy($request->input('sort_by'), $sortOrder);
        }
